...
from services import gemini, pdf as pdf_service, supabase as supa
...
def analyse(req: AnalyseRequest):
    ...
    try:
        return gemini.analyse_resume(req.resume_text, req.job_description)
    except Exception as e:
